...
// kodun mantığı basit burada kontrol blokları sıra sıra oluşuyor 
// ilk reset in pasif olamsı ile load kısmı çalıştırılır 
// load==0 ise kaydırma değil paralel yükleme olur yani giriş direkt çıkışa verilir
// looad==1 iken kaydırma aktif olur 
// bu durumda shift_left_right durumu inelennir eğer 0 ise sola kaydırılır 1 ise sağa kaydırılır 
