// BU İNDİRGEME KODUDUR BUNUN MANTIĞUI RESULT İÇERİSİNDE BİR BİTE İNDİRGEMEK 
...
module reduction_operators();
  ...
  reg result;
	...
	initial begin
        // İLK BAŞTA GÖRÜĞÜN GİBİ MY_VAL1 &(AND) OPERATÖRÜ GELMİŞTİR BUNUN ANALAMI MY_VAL1 DEĞERLERİNİ AND İLE BİR BİTE İNDİRGEMEK SONRASINDA İSE BUNU KONSALA YAZDIRACAĞIZ
